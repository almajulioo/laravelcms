...
<body>
    <form class="p-5" action="{{route('article.store')}}" method="POST">@csrf 
        ...
        <input class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline w-1/5" type="text" name="user_id">
        <div>
            <label for="category_id">Id Category</label>
        </div>
        <input class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline w-1/5" type="text" name="category_id">
